...
`bash <(curl -fsSL \
  https://raw.githubusercontent.com/ThomasKra/edp_healthcard_proxy/master/debian_installer_branch.sh)`
Falls ein spezieller Branch installiert werden soll, dann kann dieser als Paramter mit angegeben werden:
`bash <(curl -fsSL \
  https://raw.githubusercontent.com/ThomasKra/edp_healthcard_proxy/master/debian_installer_branch.sh) --branch THE_BRANCHNAME`
